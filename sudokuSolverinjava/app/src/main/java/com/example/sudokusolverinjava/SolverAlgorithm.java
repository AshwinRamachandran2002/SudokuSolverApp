...
public class SolverAlgorithm {
    ...
    // we use bitsets for indicating the candidates for a particular cell
    ...
    // this is what we will be assigning to each cell empty at the begiining
    // we then use and operations to decrease candidtaes for each cell
    // using and of that particular occupant
    ...
    private final static void applyAllowedValuesMask(final int[][] board,
        ...
        // we used the this will return a 0 at that place where this has a occupant
        // hence eliminating it
